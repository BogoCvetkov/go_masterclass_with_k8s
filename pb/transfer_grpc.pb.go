...
const (
	TransferService_CreateTransfer_FullMethodName = "/TransferService/CreateTransfer"
)
...
type TransferServiceClient interface {
	CreateTransfer(ctx context.Context, in *CreateTransferReq, opts ...grpc.CallOption) (*CreateTransferRes, error)
}
...
func (c *transferServiceClient) CreateTransfer(ctx context.Context, in *CreateTransferReq, opts ...grpc.CallOption) (*CreateTransferRes, error) {
	out := new(CreateTransferRes)
...
type TransferServiceServer interface {
	CreateTransfer(context.Context, *CreateTransferReq) (*CreateTransferRes, error)
...
func (UnimplementedTransferServiceServer) CreateTransfer(context.Context, *CreateTransferReq) (*CreateTransferRes, error) {
...
func _TransferService_CreateTransfer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransferServiceServer).CreateTransfer(ctx, req.(*CreateTransferReq))
	}
